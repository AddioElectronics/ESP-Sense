...
int Mqtt::DeviceManager::PackDeviceInfo(JsonDocument& doc, JsonObject* optObj)
{
	JsonObject parent = optObj == nullptr ? doc.createNestedObject("mqttDeviceInfo") : optObj->createNestedObject("mqttDeviceInfo");
