...
const char* config_source_strings[5]		= { "default", "fs", "eeprom", "firmware", "backupfs" };
...
ConfigSource config_source_values[5]		= { ConfigSource::CFG_DEFAULT, ConfigSource::CFG_FILESYSTEM, ConfigSource::CFG_EEPROM, ConfigSource::CFG_FIRMWARE, ConfigSource::CFG_BACKUP_FILESYSTEM };
